...
class Todo {
    ...
    var title: String = "" //An sang
    var isSelected: Bool = false // False la box, va nguoc lai
    var date: Date?
    
    init(title: String, isSelected: Bool, date: Date) {
        self.title = title
    ...
    func formartDate() -> String {
        ...
        formarter.dateFormat = "hh:mm a"
        
        //unwrapping date
        guard let d = self.date else { return ""}
        
        return formarter.string(from: d)
    }
